<?php
    ...
    $id = $title =$image =$original_price= $price =$quatity =$indexing =$id_category =$content =$level ='';
    ...
    if(!empty($_POST)){
        ...
        if ( isset($_FILES['image'])) {
            $file = $_FILES['image'];
            $file_name = $file['name'];
            move_uploaded_file($file['tmp_name'], '../../uploads/upload/' .$file_name);
        }
        ...
        if(!empty($title)) {
           $created_at = $updated_at = date('y-m-d h:s:i');
            ...
            if($id =='')
            {
                $sql='insert into product(title,image,original_price,price,
                 quatity,indexing, id_category,content,level,created_at,updated_at)
                value ("'.$title.'","'.$file_name.'","'.$original_price.'","'.$price.'",
                "'.$quatity.'","'.$indexing.'","'.$id_category.'","'.$content.'","'.$level.'",
            ...
            // update product
                ...
                $sql= 'update product set title="'.$title.'", image="'.$file_name.'",
                original_price= "'.$original_price.'", price= "'.$price.'",
                quatity="'.$quatity.'", indexing="'.$indexing.'", id_category="'.$id_category.'",
                content="'.$content.'",level="'.$level.'" where id ='.$id;
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                          ...
                          <input required="true" type="text"
                           ...
                           value ="<?=$title?>" style="text-transform: capitalize;">
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <input required="true" type="file"
                           ...
                           value ="../../uploads/upload/<?=$file_name?>"onchange="updateImage()">
                           <img src="../../uploads/upload/<?=$file_name?>" style="max-width:200px;margin-top:10px;" 
                           id="img_change">
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <input required="true" type="number"
                           class="form-control" id="quatity" name="quatity"
                           value ="<?=$quatity?>">
                    </div>

                    <div class="form-group">
                          <label for="indexing">Chỉ Mục</label>
                          <input required="true" type="text"
                           class="form-control" id="indexing" name="indexing"
                           value ="<?=$indexing?>" style="text-transform: capitalize;">
                    </div>
                    <div class="form-group">

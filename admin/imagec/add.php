    ...
    if(!empty($_POST)){
        ...
        if(isset($_POST['id'])) {
           ...
           if ( isset($_FILES['image'])) {
            $file = $_FILES['image'];
            $file_name = $file['name'];
            move_uploaded_file($file['tmp_name'], '../../uploads/upload/imagechild/' .$file_name);
        }
        ...
        if(!empty($file_name)) {
           $created_at = $updated_at = date('y-m-d h:s:i');
            ...
            if($id =='')
            {
                $sql='insert into imagechild(image, id_product,created_at,updated_at,title)
                values("'.$file_name.'","'.$id_product.'","'.$created_at.'","'.$updated_at.'", "'.$title.'")';
            }
            // update category
            else{

                $sql= 'update imagechild set  image="'.$file_name.'",
                  id_product="'.$id_product.'" where id ='.$id;
...
// kiểm tra update imagechild
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql='select * from imagechild where id ='.$id;
    $imagechild = executeSingleResult($sql);
    if($imagechild !=null){
        $file_name =$imagechild['image'];
        $id_product =$imagechild['id_product'];
    }
}
?>
<!DOCTYPE html>
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="./index.php">Quản Lý Hình Ảnh</a>
        </li>
    ...
    <div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Thêm/ Sửa Ảnh</h2>
			</div>
			<div class="panel-body">
                ...
                <div class="form-group">
                          ...
                          id="image" name="image",
                           value ="../../uploads/upload/imagechild/<?=$file_name?>">
                           <img src="../../uploads/upload/imagechild/<?=$file_name?>"
                    ...
                    <div class="form-group">
                          ...
                          <select name="id_product" class="form-control"
                           ...
                           <option value="">---Lựa chọn Tên Sản Phẩm---</option>
                            <?php
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
     ...
     <script>
        function deleteCategory(id){
            var options = confirm('Bạn có muốn xóa danh mục này không?')
            if(!options){
                return ;
            }
            //ajax lenh post

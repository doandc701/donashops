...
<meta charset="utf-8" />
  ...
  <!-- <link rel="apple-touch-icon" sizes="76x76" href="../../bootrapassets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="../../bootrap/assets/img/favicon.png"> -->
  ...
  <!-- Nucleo Icons -->
  <link href="../../bootrap/assets/css/nucleo-icons.css" rel="stylesheet" />
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#">Quản Lý Hình Ảnh</a>
            </li>
			...
			<div class="panel-heading">
                ...
                <div class="panel-body">
                     <!-- search -->
                        ...
                        <a href="add.php"><button class="btn btn-success" style="margin-bottom: 15px;">Thêm Ảnh</button></a>
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $sql ="select count(*) as 'Total' from imagechild";
                                ...
                                //Lấy hình ảnh từ database
                                    $sql="select imagechild.id, imagechild.image,imagechild.id_product,
                                    imagechild.updated_at,
                                    product.title product_title from imagechild left
                                    join product on imagechild.id_product = product.id limit $currentIndex,".PAGE_NUMBER_MAX;
                                    ...
                                    if(isset($_GET['search'])){
                                      ...
                                      imagechild.updated_at,
                                      product.title product_title from imagechild left
                                      join product on imagechild.id_product = product.id  
                                      where product.title like '%$search%' order by level asc limit $currentIndex,".PAGE_NUMBER_MAX;
                                    }
                                    $imagechildList = executeResult($sql);
                                $index =1;
                                    foreach($imagechildList as $item)
                                    {
                                        echo'<tr>
                                            <td>'.($index++).'</td>
                                            <td><img src="/wb_php/uploads/upload/imagechild/'.$item['image'].'" style="max-width:100px"></td>
                                            <td style="text-transform:capitalize">'.$item['product_title'].'</td>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        // tối ưu phân trang ...                 
                        $pageAvailable =[1,2,$page -1, $page, $page+1, $numPages-1,$numPages ];
                        $isFirst =false;
                        $isBefore =false;
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
     ...
     <script>
        function deleteCategory(id){
            var options = confirm('Bạn có muốn xóa ảnh này không?')
            if(!options){
                return ;
            }
            //ajax lenh post

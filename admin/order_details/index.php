  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./index.php">Chi Tiết Đơn Hàng</a>
            </li>
        </ul>
                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            //Lấy danh mục từ database
                                $sql='select order_details.id, order_details.order_id,
                                      order_details.product_id,order_details.num,order_details.price,
                                      product.title product_title,orders.fullname orders_fullname FROM order_details LEFT
                                ...
                                foreach($orderList as $item)
                                {
                                    echo'
                                            <tr>
                                            <td>'.($index++).'</td>
                                            <td style="text-transform:capitalize">'.$item['orders_fullname'].'</td>
                                            <td style="text-transform:capitaliza">'.$item['product_title'].'</td>
                                            <td>'.$item['num'].'</td>

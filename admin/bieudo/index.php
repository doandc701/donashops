...
<head>
  ...
  <title>Home</title>
  <link rel="stylesheet" href="../../assets/css/bieudo.css">
...
.chart-layout_item{
   ...
   /* background-image: linear-gradient( #8B008B, #A80000);  */
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="../bieudo/">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="main">
        <h1 class="lable">Số Lượng Các Loại Giày Bán Ra: </h1>
        <div class="chart-layout">
            <div class="chart-layout_item" style="--percent: 50%">Giày Vans 50%</div>
            <div class="chart-layout_item" style="--percent: 78%">Giày Adidas 78%</div>
            <div class="chart-layout_item" style="--percent: 45%">Giày Converse 45%</div>
            <div class="chart-layout_item" style="--percent: 70%">Giày Gucci  70%</div>
            <div class="chart-layout_item" style="--percent: 55%">Giày Puma  55%</div>
            <div class="chart-layout_item" style="--percent: 90%">Giày Nike &nbsp 90%</div>
            <div class="chart-layout_item" style="--percent: 80%">Giày MLB 80%</div>
            <div class="chart-layout_item" style="--percent: 69%">Giày MC Queen 69%</div>
            <div class="chart-layout_item" style="--percent: 96%">Boot Nam Nữ 96%</div>
        </div>
    </div>
    </div>
  </main>
